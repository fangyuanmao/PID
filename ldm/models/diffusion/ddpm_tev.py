...
class LatentDiffusion(DDPM):
    ...
    def __init__(self,
        ...
        self.HADARloss = HADARloss(vnums=vnums)
    ...
    def get_loss_rec(self, x):
        ...
        tev_pred = self.tev_net(x_decode)
        x_decode_rec = self.HADARloss.rec(tev_pred, x_decode)
        x_decode_mean = torch.mean(x_decode, dim=1).unsqueeze(1)
        return torch.nn.functional.mse_loss(x_decode_rec, x_decode_mean, reduction='none')
