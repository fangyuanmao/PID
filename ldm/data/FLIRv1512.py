...
class FLIRBase(Dataset):
    ...
    def __getitem__(self, i):
        ...
        # image_vi = self.gray_enhance.gray_enhance(image_vi).astype(np.uint8)
...
class FLIRTrain(FLIRBase):
    def __init__(self, **kwargs):
        super().__init__(txt_file="data/FLIRv1512/FLIR_512_train.txt", 
                         data_root="/public/home/maofangyuan/dataset/FLIRv1/FLIR_512/train", 
                         **kwargs)


class FLIRVal(FLIRBase):
    def __init__(self, flip_p=0., **kwargs):
        super().__init__(txt_file="data/FLIRv1512/FLIR_512_val.txt", 
                         data_root="/public/home/maofangyuan/dataset/FLIRv1/FLIR_512/val",
